...
data class Compare(val field: Field,
                   ...
                   val values: Array<Value>) : ConstraintExpr {
    ...
    val valueList: Array<Value> = values
    ...
    companion object {
        ...
        fun inn(field: Field, vararg value: Value): Compare {
            return Compare(field, CompareOperator.IN, value.copyOf())
        }

        fun notIn(field: Field, vararg value: Value): Compare {
            return Compare(field, CompareOperator.NOT_IN, value.copyOf())
        }

        fun create(field: Field, operator: CompareOperator, value: Value): Compare {
            return Compare(field, operator, arrayOf(value))
        }

        fun create(field: Field, operator: CompareOperator, value: Array<Value>): Compare {
