...
class MDExpandedPanel(val expandAction: SelectableAction) : Div() {
    ...
    val content: MDExpandedContent by lazy {
        MDExpandedContent()
    }
    ...
    companion object MDExpandedPanel : StyledClass {
        ...
        override val classSelector = "$pkg-expanded-panel".toClassSelector()
