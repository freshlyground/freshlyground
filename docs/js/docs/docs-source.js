...
this['docs-source'] = function (_, Kotlin, $module$beans, $module$elements) {
  ...
  var drawer = $module$beans.fg.beans.drawer_73qr15$;
  ...
  function main$lambda$lambda$lambda$lambda_3(it) {
    window.location.href = '#Resources';
  }
  function main$lambda$lambda$lambda$lambda_4($receiver) {
  }
  function main$lambda$lambda$lambda(closure$beansAction, closure$beansContainer) {
    return function ($receiver) {
      $receiver.style.display = Display.flex;
      $receiver.style.flexDirection = FlexDirection.column;
      button($receiver, new Action('Elements', void 0, void 0, void 0, main$lambda$lambda$lambda$lambda), main$lambda$lambda$lambda$lambda_0);
      toggleButton($receiver, closure$beansAction, main$lambda$lambda$lambda$lambda_1);
      $receiver.appendChild_sr04hg$(closure$beansContainer);
      button($receiver, new Action('Material Design'), main$lambda$lambda$lambda$lambda_2);
      button($receiver, new Action('Resources', void 0, void 0, void 0, main$lambda$lambda$lambda$lambda_3), main$lambda$lambda$lambda$lambda_4);
    };
  }
  function main$lambda$lambda_3(closure$beansAction, closure$beansContainer) {
    return function ($receiver) {
      $receiver._style.borderLeft = '1px solid black';
      div($receiver, main$lambda$lambda$lambda(closure$beansAction, closure$beansContainer));
    };
  }
  ...
  function main$lambda$lambda_4($receiver) {
    h1($receiver, main$lambda$lambda$lambda_0);
    p($receiver, main$lambda$lambda$lambda_1);
  }
  ...
  function main$lambda$lambda_8($receiver) {
    a($receiver, 'api/elements/index.html', '_blank', main$lambda$lambda$lambda_2);
  }
  ...
  function main$lambda$lambda_14($receiver) {
    a($receiver, 'api/beans/index.html', '_blank', main$lambda$lambda$lambda_3);
  }
  function main$lambda$lambda_15($receiver) {
    $receiver.unaryPlus_pdl1vz$('Menu');
  }
  function main$lambda$lambda$lambda$lambda_5(it) {
  }
  function main$lambda$lambda$lambda$lambda_6($receiver) {
  }
  function main$lambda$lambda$lambda$lambda_7(it) {
  }
  function main$lambda$lambda$lambda$lambda_8($receiver) {
  }
  function main$lambda$lambda$lambda_4($receiver) {
    menuItem($receiver, new SelectableAction('Menu Item 1', void 0, void 0, void 0, void 0, void 0, main$lambda$lambda$lambda$lambda_5), main$lambda$lambda$lambda$lambda_6);
    menuItem($receiver, new SelectableAction('Menu Item 2', void 0, void 0, void 0, void 0, void 0, main$lambda$lambda$lambda$lambda_7), main$lambda$lambda$lambda$lambda_8);
  }
  function main$lambda$lambda_16($receiver) {
    menu_0($receiver, void 0, main$lambda$lambda$lambda_4);
  }
  ...
  function main$lambda$lambda$lambda_7(it) {
  }
  function main$lambda$lambda$lambda_8($receiver) {
  }
  function main$lambda$lambda_18($receiver) {
    button($receiver, new Action('Button 1', void 0, void 0, void 0, main$lambda$lambda$lambda_5), main$lambda$lambda$lambda_6);
    button($receiver, new Action(void 0, void 0, icon_0.FontAwesomeIcons.camera_retro_p56ikg$(), void 0, main$lambda$lambda$lambda_7), main$lambda$lambda$lambda_8);
  }
  ...
  function main$lambda$lambda$lambda_9($receiver) {
    a($receiver, 'https://kotlinlang.org/', '_blank', main$lambda$lambda$lambda$lambda_9);
  }
  ...
  function main$lambda$lambda$lambda_10($receiver) {
    a($receiver, 'https://www.w3.org/TR/html5/', '_blank', main$lambda$lambda$lambda$lambda_10);
  }
  ...
  function main$lambda$lambda$lambda_11($receiver) {
    a($receiver, 'http://html5doctor.com/', '_blank', main$lambda$lambda$lambda$lambda_11);
  }
  ...
  function main$lambda$lambda$lambda_12($receiver) {
    a($receiver, 'https://developer.mozilla.org', '_blank', main$lambda$lambda$lambda$lambda_12);
  }
  function main$lambda$lambda_20($receiver) {
    ...
    li($receiver, main$lambda$lambda$lambda_12);
  }
  function main$lambda_1(closure$beansAction, closure$beansContainer) {
    return function ($receiver) {
      drawer($receiver, Side.RIGHT, main$lambda$lambda_3(closure$beansAction, closure$beansContainer));
  ...
  function main$lambda$lambda_21($receiver) {
    and($receiver, SelectableAction.Statics.selectedSelector, main$lambda$lambda$lambda_13);
  }
  function main$lambda_3($receiver) {
    desc($receiver, MenuItem.MenuItem.classSelector, main$lambda$lambda_21);
  }
  ...
  function main(args) {
    var beansAction = new SelectableAction('Beans', void 0, void 0, void 0, void 0, void 0, main$lambda);
    var beansContainer = with_0(new Div(), main$lambda_0);
    collapseOn(beansContainer, beansAction);
    beansAction.selected = false;
    with_0(elements_0.BODY, main$lambda_1(beansAction, beansContainer));
    elements_0.HTML.addCSSRule_t83c1i$(with_0(new AnyRule(), main$lambda_2));
    elements_0.HTML.addCSSRule_t83c1i$(with_0(new ClassRule(Menu.Menu.classSelector), main$lambda_3));
    elements_0.HTML.addCSSRule_t83c1i$(with_0(new ClassRule(MenuItem.MenuItem.classSelector), main$lambda_4));
